...
Subsnub is free to use. You connect your Google account, it pulls your subscriptions, sorts them into category feeds, and that's it. No manual setup, no tagging, no algorithm trying to decide what you should watch. Just your channels, organised the way they should've been from the start.
...
[Try Subsnub for free →](https://getsubsnub.com)
