...
export const metadata = { title: 'Freedly — Privacy Policy' };
...
export default function PrivacyPage() {
  return (
    <LegalPage>
      ...
      <p>Freedly (&ldquo;we&rdquo;, &ldquo;our&rdquo;, &ldquo;us&rdquo;) operates the website usefreedly.com. This policy explains what data we collect, why we collect it, how we use it, and your rights regarding that data.</p>
      ...
      <p><strong>YouTube subscription data.</strong> With your permission, we access your YouTube subscription list through the YouTube Data API. This allows us to display and organise your subscribed channels within Freedly. We store your subscription data in our database to provide the service.</p>
      <p><strong>Usage data.</strong> We collect information about how you use Freedly, including which features you use, your category preferences, channel favourites, notes you create, and general interaction patterns. This helps us improve the product.</p>
      ...
      <ul>
        <li>Provide the Freedly service, including organising your subscriptions and delivering personalised feeds</li>
      ...
      <p>We use the following third-party services to operate Freedly:</p>
      <ul>
      ...
      <p>Freedly&rsquo;s use and transfer of information received from Google APIs adheres to the Google API Services User Data Policy, including the Limited Use requirements. We only use YouTube API data to provide the features described in this policy and do not use it for any other purpose.</p>
      ...
      <h2>Cookies</h2>
      <p>Freedly uses essential cookies required for the service to function (authentication session cookies). We do not use tracking cookies or third-party advertising cookies.</p>

      <h2>Children</h2>
      <p>Freedly is not intended for use by anyone under the age of 13. We do not knowingly collect data from children.</p>

      <h2>Changes to this policy</h2>
      <p>We may update this policy from time to time. If we make significant changes, we will notify you by email or through a notice on the website. Continued use of Freedly after changes constitutes acceptance of the updated policy.</p>
